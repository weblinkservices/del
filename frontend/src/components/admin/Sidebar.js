        ...
        <div className="sidebar-wrapper">
            <nav id="sidebar">
                <ul className="list-unstyled components">
                    ...
                    <li>
                        <a href="#orderSubmenu" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle"><i
                            className="fa fa-shopping-basket"></i> Orders</a>
                        <ul className="collapse list-unstyled" id="orderSubmenu">
                            ...
                            <li>
                                <Link to="/admin/orders"><i className="fa fa-eye"></i>View</Link>
                            </li>
                        </ul>
                    </li>
